...
(function ($) {
    $.fn.pagepiling = function (options) {
        ...
        //BE CAREFUL! Not recommend to change it under 400 for a good behavior in laptops and
        ...
        options = $.extend({
            ...
            navigation: {
                ...
                'bulletsColor': '#000',
                'position': 'right',
                'tooltips': ['封面','关于我','项目经验','擅长技术','了解更多']
            },
        ...
        function scrollToAnchor() {
            ...
            if (section.length > 0) {  //if there's any #
        ...
        function addMouseWheelHandler() {
            if (container.get(0).addEventListener) {
                container.get(0).addEventListener("mousewheel", MouseWheelHandler, false); //IE9, Chrome, Safari, Opera
